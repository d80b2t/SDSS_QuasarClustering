...
;;
plot_error1 = 'y'
read, plot_error1, PROMPT='Plot the Poisson:Jackknife scaled points and errors?  '

plot_error2 = 'n'
;read, plot_error2, PROMPT='Plot the geometric mean errors?  '

plot_error3 = 'n'
read, plot_error3, PROMPT='Plot the "summed variances" Poisson points and errors?  '

plot_plfits1 = 'n' 
read, plot_plfits1, PROMPT='Plot the Poisson:jackknife power-law fits?  '
;; from e.g. the "averaged" fitting

plot_plfits2 = 'n'
read, plot_plfits2 , PROMPT='Plot the "summed variances" power law fits?  '
;; from e.g. the "summed poisson" fitting
print
print

;; Power - law parameters. 
;; These were held fixed for both sets of fits. 
;; 
gamma = 2.0
A     = !dpi
...
if plot_error1 eq 'y' then begin
   plotsym, 0, 1.0, /fill, thick=2
   oplot,   sigma_0pnt00,  wpsigma_div_sigma_0pnt00, psym=8, color=clr_scaled
   errplot, sigma_0pnt00, $
            (wpsigma_div_sigma_0pnt00-error_0pnt00_div_sigma), $
            (wpsigma_div_sigma_0pnt00+error_0pnt00_div_sigma), $
            thick=2.0, linestyle=0, color=clr_scaled
endif

if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 8.95
   plfit_0pnt00 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_0pnt00, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 9.12
   plfit2_0pnt00 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_0pnt00, color=clr_summed, thick=3, linestyle = 2 
endif


error3                      = (delta_0pnt00_v2     /sigma_0pnt00v2)
if plot_error3 eq 'y' then begin
   plotsym, 0, 1.0, thick=2
   oplot,   sigma_0pnt00v2,  wpsigma_div_sigma_0pnt00v2, psym=8, color=clr_summed
   errplot, sigma_0pnt00v2, $
            (wpsigma_div_sigma_0pnt00v2-error3), $
            (wpsigma_div_sigma_0pnt00v2+error3), $
            thick=3.0,       linestyle=1,         color=clr_summed
endif 
...
if plot_error2 eq 'y' then begin
   errplot, sigma_0pnt00, $
            ...
            (wpsigma_div_sigma_0pnt00+error2_div_sigma_0pnt00), $
            thick=2.0,                linestyle=1, color=clr_geo
endif
...
if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 =6.14
   plfit2_0pnt30 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_0pnt30, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 6.18
   plfit2_0pnt68 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_0pnt68, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 5.57  ;; +/- 0.10
   plfit2_0pnt92 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_0pnt92, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 =  7.03
   plfit2_1pnt13 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_1pnt13, color=clr_summed, thick=3, linestyle = 2 
endif
...
wpsigma_div_sigma_1pnt32v2 = Xi_sigma_LS_1pnt32v2 / sigma_1pnt32v2
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 7.26 ;; +/- 0.93
   plfit_1pnt32 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_1pnt32, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 0.01
   plfit2_1pnt32 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_1pnt32, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 8.34  ;; +/- 0.84
   plfit_1pnt50 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_1pnt50, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 8.11
   plfit2_1pnt50 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_1pnt50, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 7.83  ;; +/- 0.71
   plfit_1pnt66 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_1pnt66, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 7.37
   plfit2_1pnt66 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_1pnt66, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 9.38  ;; +/- 0.79
   plfit_1pnt83 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_1pnt83, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 9.10 
   plfit2_1pnt83 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_1pnt83, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 10.50   ;; +/- 0.96
   plfit_2pnt02 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_2pnt02, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 8.73
   plfit2_2pnt02 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_2pnt02, color=clr_summed, thick=3, linestyle = 2 
endif
...
if plot_plfits1 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit = 13.51  ;; +/- 1.81
   plfit_2pnt20 = ((r0_fit/rp_set)^gamma) * A
   oplot, rp_set, plfit_2pnt20, color=clr_scaled, thick=2, linestyle = 1 
endif

if plot_plfits2 eq 'y' then begin
   rp_set = findgen(130)
   r0_fit2 = 16.13
   plfit2_2pnt20 = ((r0_fit2/rp_set)^gamma) * A
   oplot, rp_set, plfit2_2pnt20, color=clr_summed, thick=3, linestyle = 2 
endif
