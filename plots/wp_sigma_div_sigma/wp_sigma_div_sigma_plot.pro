...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
;; 
;;  wp(rp) / rp     SINGLE  POWER-LAW  FIT   from   wp(sigma)/sigma
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
choice_plfit = 'n'
...
if (choice_plfit eq 'y') then begin
   ...
   ;; These power-law fits are from using a simple chi^2 method.
   ;; See r0_gamma_from_wpsigma_DR5Q  in  progs/chisq/wpsigma_div_sigma/
...
;;   ****   Fibre collison v2   ****
;;   
   readcol, '../../jackknife/wp_sigma/K_wp_output_UNI22_jackknife_errors_for_wFibre_v2.dat', $
            i_bin, j_bin, COV_ii, jack

   readcol, '../../OP/OP_UNI22_wFibre/K_wp_output_UNI22_wFibre_v2.dat', $
            sigma, lg_sigma, Xi_sigma, delta_Xi_sigma, $
            bin_DD_sigma, bin_DR_sigma, $
            Xi_sigma_HAM, Xi_sigma_LS
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;   
;;
;;   Fibre collisions, Bottom panel...
;;
   if choice_UNI22_fibre eq 'y' then begin
      readcol, '../../jackknife/wp_sigma/K_wp_output_UNI22_jackknife_errors_for_wFibre.dat', ii,jj, cov, jack
      readcol, '../../OP/OP_UNI22_wFibre/K_wp_output_UNI22_wFibre.dat', $
               sigma, lg_sigma, Xi_sigma, delta_Xi_sigma, $
               bin_DD_sigma, bin_DR_sigma, $
               Xi_sigma_HAM, Xi_sigma_LS
      ...
      plotsym, 0, 0.75, /fill
      oplot, sigma, wp_sigma_q_div_plfit, psym=8, color=128
      oplot, sigma, wp_sigma_q_div_plfit, linestyle=4, color=128
      errplot, sigma, (err_plus),  (err_minus), thick=4.0, color=128, linestyle=1
      
      readcol, '../../jackknife/wp_sigma/K_wp_output_UNI22_jackknife_errors_for_wFibre_v2.dat', ii,jj, cov, jack
