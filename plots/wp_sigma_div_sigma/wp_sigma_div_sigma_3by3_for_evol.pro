...
set_plot, 'ps'
device, filename='wp_sigma_div_sigma_DR5_quasars_3by3_for_evol_temp.eps', $
        xsize=9.0, ysize=6.5, $
        /encapsulated, $
...
xyouts, 10., 100., '<z>=2.13', charsize=1.2, charthick=4.2,    color=0 ;48
