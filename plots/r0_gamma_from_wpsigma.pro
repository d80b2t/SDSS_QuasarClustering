...
print, 'OP/K_wp_output_UNI22_0pnt00z0pnt30.dat read-in '
;; same as OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_0pnt00z0pnt68.dat

w = where(Xi_sigma_LS_0pnt00 gt 0. and sigma gt sigma_min, N)
r_nought_0pnt00 = (Xi_sigma_LS_0pnt00[w] / ((sigma_0pnt00[w]^(1.0d - gamma_fixed))*A)) $
                  ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_UNI22_0pnt00z0pnt68.dat', mean(r_nought_0pnt00), $
...
;; same as OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_0pnt30z0pnt68.dat

w = where(Xi_sigma_LS_0pnt30 gt 0. and sigma gt sigma_min, N)
r_nought_0pnt30 = (Xi_sigma_LS_0pnt30[w] / ((sigma_0pnt30[w]^(1.0d - gamma_fixed))*A)) $
                  ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_UNI22_0pnt30z0pnt68.dat', mean(r_nought_0pnt30), $
...
;; same as OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_0pnt68z0pnt92.dat

w = where(Xi_sigma_LS_0pnt68 gt 0. and sigma gt sigma_min, N)
r_nought_0pnt68 = (Xi_sigma_LS_0pnt68[w]/ ((sigma_0pnt68[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_UNI22_0pnt68z0pnt92.dat', mean(r_nought_0pnt68), '  +/-', stddev(r_nought_0pnt68), '  from ', n_elements(Xi_sigma_LS_0pnt68[w]), ' points, thus SEM =', stddev(r_nought_0pnt68)/ (sqrt(n_elements(Xi_sigma_LS_0pnt68[w])))
print
print
...
;; same as OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_0pnt92z1pnt13.dat


w = where(Xi_sigma_LS_0pnt92 gt 0. and sigma gt sigma_min, N)
r_nought_0pnt92 = (Xi_sigma_LS_0pnt92[w] / ((sigma_0pnt92[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_UNI22_0pnt92z1pnt13.dat', mean(r_nought_0pnt92), '  +/-', stddev(r_nought_0pnt92), '  from ', n_elements(Xi_sigma_LS_0pnt92[w]), ' points,  thus SEM =', stddev(r_nought_0pnt92)/ (sqrt(n_elements(Xi_sigma_LS_0pnt92[w])))
print
print
...
print, ' READ-IN  OP/UNI22_evol_5logbins_wpsigma/K_wp_output_1pnt13z1pnt32.dat '
w = where(Xi_sigma_LS_1pnt13 gt 0. and sigma gt sigma_min, N)
r_nought_1pnt13 = (Xi_sigma_LS_1pnt13[w] / ((sigma_1pnt13[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_UNI22_1pnt13z1pnt32.dat', mean(r_nought_1pnt13), '  +/-', stddev(r_nought_1pnt13), '  from ', n_elements(Xi_sigma_LS_1pnt13[w]), ' points, thus SEM =', stddev(r_nought_1pnt13)/ (sqrt(n_elements(Xi_sigma_LS_1pnt13[w])))
print
print
...
print, ' UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_1pnt32z1pnt50.dat read-in'

w = where(Xi_sigma_LS_1pnt32 gt 0. and sigma gt sigma_min, N)
r_nought_1pnt32 = (Xi_sigma_LS_1pnt32[w] / ((sigma_1pnt32[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_1pnt13z1pnt32.dat', mean(r_nought_1pnt32), '  +/-', stddev(r_nought_1pnt32), '  from ', n_elements(Xi_sigma_LS_1pnt32[w]), ' points, thus SEM =', stddev(r_nought_1pnt32)/ (sqrt(n_elements(Xi_sigma_LS_1pnt32[w])))
print
print
...
print, 'OP/UNI22_evol_5logbins_wpsigma/K_wp_output_1pnt50z1pnt66.dat'

w = where(Xi_sigma_LS_1pnt50 gt 0. and sigma gt sigma_min, N)
r_nought_1pnt50 = (Xi_sigma_LS_1pnt50[w] / ((sigma_1pnt50[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_1pnt50z1pnt66.dat', mean(r_nought_1pnt50), '  +/-', stddev(r_nought_1pnt50), '  from ', n_elements(Xi_sigma_LS_1pnt50[w]), ' points, thus SEM =', stddev(r_nought_1pnt50)/ (sqrt(n_elements(Xi_sigma_LS_1pnt50[w])))
print
print
...
print, 'OP/UNI22_evol_5logbins_wpsigma/K_wp_output_1pnt66z1pnt83.dat'

w = where(Xi_sigma_LS_1pnt66 gt 0. and sigma gt sigma_min, N)
r_nought_1pnt66 = (Xi_sigma_LS_1pnt66[w] / ((sigma_1pnt66[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for  K_wp_output_1pnt66z1pnt83.dat', mean(r_nought_1pnt66), '  +/-', stddev(r_nought_1pnt66), '  from ', n_elements(Xi_sigma_LS_1pnt66[w]), ' points, thus SEM =', stddev(r_nought_1pnt66)/ (sqrt(n_elements(Xi_sigma_LS_1pnt66[w])))
print
print
...
print, "OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_1pnt83z2pnt02.dat"

w = where(Xi_sigma_LS_1pnt83 gt 0. and sigma gt sigma_min, N)
r_nought_1pnt83 = (Xi_sigma_LS_1pnt83[w] / ((sigma_1pnt83[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for K_wp_output_UNI22_1pnt83z2pnt02.dat', mean(r_nought_1pnt83), '  +/-', stddev(r_nought_1pnt83), '  from ', n_elements(Xi_sigma_LS_1pnt83[w]), ' points, thus SEM =', stddev(r_nought_1pnt83)/ (sqrt(n_elements(Xi_sigma_LS_1pnt83[w])))
print
print
...
print, "OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_2pnt02z2pnt20.dat"
...
r_nought_2pnt02 = (Xi_sigma_LS_2pnt02[w] / ((sigma_2pnt02[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for K_wp_output_UNI22_2pnt02z2pnt20.dat', mean(r_nought_2pnt02), '  +/-', stddev(r_nought_2pnt02), '  from ', n_elements(Xi_sigma_LS_2pnt02[w]), ' points, thus SEM =', stddev(r_nought_2pnt02)/ (sqrt(n_elements(Xi_sigma_LS_2pnt02[w])))
print
print
...
readcol, "OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_2pnt20z2pnt90.dat", $
         sigma_2pnt02, lg_sigma, Xi_sigma, delta_Xi_sigma, DD_2pnt02, DR,  $
         Xi_sigma_HAM, Xi_sigma_LS_2pnt02, /SILENT
print, "OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_2pnt20z2pnt90.dat"

w = where(Xi_sigma_LS_2pnt02 gt 0. and sigma gt sigma_min, N)
r_nought_2pnt02 = (Xi_sigma_LS_2pnt02[w] / ((sigma_2pnt02[w]^(1.0d - gamma_fixed))*A)) $
           ^ (1.0d/(gamma_fixed))
print, 'r_0 for K_wp_output_UNI22_2pnt20z2pnt90.dat', mean(r_nought_2pnt02), '  +/-', stddev(r_nought_2pnt02), '  from ', n_elements(Xi_sigma_LS_2pnt02[w]), ' points, thus SEM =', stddev(r_nought_2pnt02)/ (sqrt(n_elements(Xi_sigma_LS_2pnt02[w])))
print
print
...
;print, "OP/UNI22_evol_5logbins_wpsigma/K_wp_output_UNI22_XRAY.dat"
print
