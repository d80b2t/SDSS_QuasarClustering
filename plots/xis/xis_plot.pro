...
;; 'OP/OP_20080510/k_output_20080510.dat' current 'best' PRI calculation
;; 'OP/OP_20080508/k_output_UNI22.dat' for Std, HAM, LS comparisons
;; 'OP/UNI22_UNI29/k_output_UNI22_UNI29.dat' for UNI z<2.9
;; 'OP/OP_20080508/k_output_UNI22_N.dat', for UNI NGC
;; 'OP/OP_20080508/k_output_UNI22_S.dat', for UNI SGC
...
;; 'OP/OP_20080516/k_output_PRI22_BadFields.dat' for the Bad fields tests
;; 'OP/OP_UNI22_EBV/k_output_UNI22_EBVle0pnt0217.dat' for the Dust Reddening
;; 'OP/OP_UNI22_wFibre/k_output_UNI22_wFibre.dat', for Fibre Collision tests
;; 'OP/OP_20080516/k_output_EmptySectors0_temp.dat' to test what
;;      effect the "empty" sectors are having...
;; '2pt/k_output_UNI22_RASS_Xray_temp.dat', is for the UNIFORM sample
;;      that is matched to the (Soft 0.1-2.4 keV) X-ray catalogues of
;;      Anderson et al. (2007). 
;;


;;48 red,  138 green,  192 blue
;;
;;  Comparison  1
;; 
   readcol, 'OP/OP_UNI22_wFibre/k_output_UNI22_wFibre.dat', $
;   readcol, 'OP/OP_20080508/k_output_UNI22_N.dat', $
...
;   xis_q_temp = xis_std          ; just setting the xi_Q(s) to the  xi_std
   poisson_temp = (1.+xis_q_temp) * (sqrt(2./DD)) ; Poisson errors    
   jack_2 = [poisson_temp[0], [jack]]
   
   plotsym, 4, 1, /fill
   oplot, s, xis_q_temp, psym=4, color=138    
   plotsym, 5, 1, /fill
   oplot, s, xis_q_temp, psym=4, color=138    
   oplot, s, xis_q_temp, linestyle=4, thick=6, color=138  ;linestyle=3 dot-dashed
   errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), $
;   errplot, s, (xis_q_temp-jack), (xis_q_temp+jack),   $
            thick=3.0, color=138, linestyle=4

   legend, [' '], box=0, position=[6.,11.], linestyle=4, thick=6, color=138
;  xyouts, 15.0, 7.0, 'E(B-V)!9l!3!N0.02', charsize=2.2, charthick=5.2, color=138
   xyouts, 15.0, 7.0, 'w/Fib corr (1)', charsize=2.2, charthick=5.2, color=138
   ;; 138= green for pri, 40 for z<2.9, 48 for NGC etc. 


choice_temp2 = 'n'
read, choice_temp2, PROMPT=' - Plot the Comparison 2 file?  y/n   '
if choice_temp2 eq 'y' then begin
;;
;;  Comparison  2
;; 

   readcol, 'OP/OP_UNI22_wFibre/k_output_UNI22_wFibre_v2.dat', $
            s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio 
   ...
   oplot, s, xis_q_temp, linestyle=1, thick=4,  color=48
   errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), $
;   errplot, s, (xis_q_temp-jack), (xis_q_temp+jack),   $
           thick=4.0, color=48, linestyle=1

   legend, [' '], box=0, position=[6.,5.5], linestyle=1, thick=6, color=48
   xyouts, 15.0, 3.5, 'w/Fib corr (2)', charsize=2.2, charthick=6.2,  color=48
endif
...
;
;   legend, [' '], box=0, position=[6.0, 2.75], linestyle=2, thick=6, color=192
;   xyouts, 15.0, 1.75, 'Standard', charsize=2.2, charthick=6.2, color=192
...
;      gamma    = 
   ...
   readcol, "OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt02z2pnt20_10log.dat", $
            s_log, s_2pnt02, xis_std, delta_xis, DD_2pnt02, DR, RR, $
            xis_LS_2pnt02, xis_HAM, ratio
   print, 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt02z2pnt20_10log.dat'
   print
...
;;48 red,  138 green,  192 blue
loadct, 6
;readcol, 'OP/OP_UNI22_EBV/k_output_UNI22_EBVle0pnt0217.dat', $
readcol, 'OP/OP_UNI22_wFibre/k_output_UNI22_wFibre.dat', $
         s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio, /silent
xis_q_temp = xis_LS
poisson_temp = (1.+xis_q_temp) * (sqrt(2./DD))
if choice_temp eq 'y' then begin
   ...
   poisson_temp = (1.+xis_q_temp) * (sqrt(2./DD))
   oplot, s, xis_q_temp, psym=4, color=138
;   oplot, s, xis_q_temp, linestyle=0, color=0
...
;readcol, 'OP/OP_UNI22_EBV/k_output_UNI22_EBVgt0pnt0217.dat', $
readcol, 'OP/OP_UNI22_wFibre/k_output_UNI22_wFibre_v2.dat', $
       s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio, /silent
xis_q_temp = xis_LS
poisson_temp = (1.+xis_q_temp) * (sqrt(2./DD))
...
;   errplot, s, (xis_q_temp-jack), (xis_q_temp+jack), $
   errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), $
            thick=3.0, color=48, linestyle=1
...
if (choice_LinLargeScales eq 'y') then begin
   ...
   loadct, 6                    ; black=0=255, red=63, green=127, blue=191
   set_plot, 'ps'
   device, filename='xis_DR5_quasars_LARGE_scales_lin_temp.eps', $
           xsize=7.5, ysize=6.0, /inches, /color, /encapsulated
   !p.multi=0

   
   plot, s, xis_q, $
         position=[0.22, 0.16, 0.96, 0.98],$
...
;            thick=4.0, color=0
   ...
   legend, [' '], linestyle=0, color=0, pos=[110.,-0.020], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=1, color=48, pos=[110.,-0.028], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=2, color=192, pos=[110.,-0.036], $
           box=0, thick=8, charthick=4.2, charsize=1.2
...
;        OP_20080120 has UNIFORM 0.30 < z < 2.90
   ...
   loadct, 6                    ; black=0=255, red=63, green=127, blue=191
   set_plot, 'ps'
   device, filename='xis_DR5_quasars_MEGA_LARGE_scales_lin_temp.eps', $
           xsize=8.5, ysize=6.0, $    ;; for appendix plot
;           xsize=16.0, ysize=7.5, 
           /encapsulated, $
;           /landscape, $
...
;            thick=4.0, color=0
   ...
   plotsym,0,1.5,/fill, thick=4
;   legend, [''], psym=8, box=0, position=[1350.,0.008125]
;   xyouts, 1500.,0.0075, 'SDSS DR5Q (uni)', charsize=2.8, charthick=5.2, color=0
;   xyouts, 1500.,0.0065,'0.3 < z < 2.2 ', charsize=2.8, charthick=5.2, color=0
endif
...
readcol, 'OP/OP_20080510/k_output_MultiplePlate.dat', $
         s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio
;readcol, '2pt/k_output_UNI22_RASS_Xray_temp.dat', $
;         s_log, s, xis_std, delta_xis, DD, DR
