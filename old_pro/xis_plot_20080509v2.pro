...
set_plot, 'ps'
device, filename='xis_DR5_quasars_temp.ps', xsize=7.5, ysize=5.0, /inches, /color
;device, filename='xis_DR5_quasars_temp.ps', xsize=7.5, ysize=5.0, /inches, /color
!p.multi=[0,1,3]
...
if (choice_SDSS_QSOs eq 'y') then begin
   ...
   xyouts, 5.0,164.0, 'SDSS DR5Q (UNI)', charsize=2.2, charthick=5.2, color=0
;   xyouts, 5.0,20.0, 'SDSS DR5 ', charsize=2.2, charthick=6.2, color=0
   xyouts, 5.0, 80.0,  '0.3 < z < 2.2 ', charsize=2.2, charthick=5.2, color=0
...
;        OP_20080120 has UNIFORM 0.30 < z < 2.90
   ...
   xyouts, 5.0, 20.0,  '0.3 < z < 2.9 ', charsize=2.2, charthick=5.2, color=24
...
;   xyouts, 5.0, 150.0, '2QZ  0.3<z<2.2',  charsize=2.2, charthick=6.2, color=160
   xyouts, 5.0, 150.0, '2QZ  ',  charsize=2.2, charthick=6.2, color=160
