...
set_plot, 'ps'
device, filename='xis_DR5_quasars_temp.ps', xsize=8, ysize=8, /inches, /color
!p.multi=[0,1,3]
...
readcol, '2pt/k_output_UNI22_temp.dat', $
...
;   readcol, ''
   ...
   loadct, 6                    ; black=0=255, red=63, green=127, blue=191
   set_plot, 'ps'
   device, filename='xis_DR5_quasars_LARGE_scales_Yahata_temp.ps', $
