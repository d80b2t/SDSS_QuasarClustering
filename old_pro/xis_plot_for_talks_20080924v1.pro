...
if (choice_SDSS_QSOs eq 'y') then begin
   ...
   oplot, s, xis_q, psym=8, thick=4*talk, color=255         ;also psym=4 is nice.
...
;   xyouts, 15.0, 45.3,  '0.3 < z < 2.2 ', charsize=2.2, charthick=6.2, color=255 ; if yrange_max=500
...
;   readcol, 'OP/OP_20080508/k_output_UNI22_S.dat', $
;  readcol, 'OP/UNI22_evol_5logbins_xis/k_output_UNI22_0pnt68z0pnt92_5log.dat', $
;  readcol, 'OP/UNI22_Xray/k_output_UNI22_RASS_Xray_20080724.dat', $
;   readcol, '2pt/k_output_PRI22_DR1_temp.dat', $
;   readcol, '2pt/k_output_UNI22_EBVle0pnt0217_temp.dat', $
...
;            s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio 
  readcol, '2pt/k_output_UNI22_RASS_Xray_temp.dat', $
   ...
   w=where(s le 25.0, N)
   plotsym, 4, 1, /fill
   oplot, s, xis_q_temp, psym=8, color=138    
   plotsym, 5, 1, /fill
   oplot, s, xis_q_temp, psym=8, color=138    
   oplot, s, xis_q_temp, linestyle=3, thick=6, color=138
   errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), $
;   oplot, s[w], xis_q_temp[w], psym=4, thick=4, color=138   ;48 is red
;   oplot, s[w], xis_q_temp[w], linestyle=3, thick=6, color=138
;   errplot, s[w], (xis_q_temp[w]-poisson_temp[w]), (xis_q_temp[w]+poisson_temp[w]), $
...
;   legend, [' '], box=0, position=[88.,28.], linestyle=3, thick=6, color=138
;   xyouts, 15.0, 16.0, 'SDSS DR5Q (pri)', charsize=2.2, charthick=5.2, color=138
   xyouts, 15.0, 16.0, 'DR5Q-RASS (AC)', charsize=2.2, charthick=5.2, color=138
;   xyouts, 15.0, 16.0, 'EDR/DR1', charsize=2.2, charthick=5.2, color=138
;   xyouts, 15.0, 16.0, 'E(B-V)!9l!30.02', charsize=2.2, charthick=5.2, color=138
;   xyouts, 15.0, 16.0, 'w/Fibre Corr', charsize=2.2, charthick=5.2, color=138
;   legend, [' '], box=0, position=[108.,28.], linestyle=3, thick=6, color=138
   plotsym, 4, 1.3, /fill
   legend, [' '], box=0, position=[10.,28.], psym=8, thick=6, color=138
   plotsym, 5, 1.3, /fill
   legend, [' '], box=0, position=[10.,28.], psym=8, thick=6, color=138
...
;   readcol, 'OP/UNI22_Xray/k_output_UNI22_RASS_Xray_20080903.dat', $
;   readcol, '2pt/k_output_PRI22_DR2345_temp.dat', $
   readcol, '2pt/k_output_UNI22_EBVgt0pnt0217_temp.dat', $
            s_log, s, xis_std, delta_xis, DD, DR, RR, xis_LS, xis_HAM, ratio 
;            s_log, s, xis_std, delta_xis, DD, DR   ;for X-cor (no RRs...)
...
;   legend, [' '], box=0, position=[8.,10], linestyle=1, thick=6, color=48
   legend, [' '], box=0, position=[10.,10], psym=4, thick=6, color=48
;   legend, [' '], box=0, position=[88.,10], linestyle=1, thick=6, color=48
...
;;   xyouts, 15.0, 5.6, 'DR2345', charsize=2.2, charthick=6.2, color=48
   xyouts, 15.0, 5.6, 'DR5Q-RASS (XC)', charsize=2.2, charthick=6.2, color=48
;   xyouts, 15.0, 5.6, 'E(B-V)>0.02', charsize=2.2, charthick=6.2, color=48
;  legend, [' '], box=0, position=[108.,10], linestyle=1, thick=6, color=48
;  legend, [' '], box=0, position=[108.,10], psym=4, thick=6, color=48
...
;   legend, [' '], box=0, position=[88.,4.], linestyle=2, thick=6, color=192
...
;   xyouts, 15.0, 1.98, 'DR5Q (pri)', charsize=2.2, charthick=6.2, color=192
...
;      ytitle=' !7n(!3s)', $
      /nodata, $
;      xtitle=' s / h!E-1!N Mpc', $
      xcharsize=1.6, ycharsize=1.2, charthick=4.2*talk
