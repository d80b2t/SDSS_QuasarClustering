...
;   xyouts, 15.0, 5.6, 'Hamilton', charsize=2.2, charthick=6.2, color=48
...
;;   xyouts, 15.0, 1.98, 'Standard', charsize=2.2, charthick=6.2, color=192
...
;        OP_20080120 has UNIFORM 0.30 < z < 2.90
   ...
   xyouts, 15.0, 16.0,  '0.3 < z < 2.9 ', charsize=2.2, charthick=5.2, color=24
...
poisson_temp = (1.+xis_q_temp) * (sqrt(2./DD))
;oplot, s, xis_q_temp, psym=4, color=48, linestyle=1
;errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), thick=3.0, color=48, linestyle=1
...
;errplot, s, (xis_q_temp-poisson_temp), (xis_q_temp+poisson_temp), thick=3.0, color=192, linestyle=1
...
;        OP_20080120 has UNIFORM 0.30 < z < 2.90
   ...
   oplot, s, xis_std, linestyle=1, color=64, thick=4.0
   oplot, (s+1.5), xis_HAM, linestyle=2, color=192, thick=4.0
...
;            thick=4.0, color=0
   ...
   xyouts, 1.0, 400, '!!!! V. PRELIMINARY RESULT !!!!', $
           charsize=2.2, charthick=6.2, color=0
   legend, [' '], linestyle=1, color=64, pos=[120.,-0.020], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=0, color=0, pos=[120.,-0.028], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=2, color=192, pos=[120.,-0.036], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   xyouts, 180, -0.025, 'Standard',     charsize=2.2, charthick=5.2, color=64
   xyouts, 180, -0.033, 'Landy-Szalay', charsize=2.2, charthick=5.2, color=0
   xyouts, 180, -0.041, 'Hamilton',     charsize=2.2, charthick=5.2, color=192
   device, /close
...
;   oplot, s, xis_q, psym=8, color=0
   oplot, s, xis_q, linestyle=0, color=0, thick=6.0
   oplot, s, xis_std, linestyle=1, color=64, thick=4.0
   oplot, (s+15), xis_HAM, linestyle=2, color=192, thick=4.0
...
;            thick=4.0, color=0
   ...
   legend, [' '], linestyle=1, color=64, pos=[1100.,0.0096], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=0, color=0, pos=[1100.,0.0086], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   legend, [' '], linestyle=2, color=192, pos=[1100.,0.0076], $
           box=0, thick=8, charthick=4.2, charsize=1.2
   xyouts, 1700, 0.009, 'Standard',     charsize=2.2, charthick=5.2, color=64
   xyouts, 1700, 0.008, 'Landy-Szalay', charsize=2.2, charthick=5.2, color=0
   xyouts, 1700, 0.007, 'Hamilton',     charsize=2.2, charthick=5.2, color=192
