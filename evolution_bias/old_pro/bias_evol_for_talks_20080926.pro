...
loadct, 0
set_plot, 'ps'
device, filename='bias_with_redshift_z6_for_talks.ps', $
        xsize=8.5, ysize=6.0,  $
...
loadct, 0
set_plot, 'ps'
device, filename='bias_with_redshift_z3_for_talks.ps', $
        xsize=8.5, ysize=6.0,  $
...
if (choice_Sheth01_fit eq 'y') then begin
   ...
   print
   loadct, 6
   oplot, z_Sheth01, S01_5d11, color=180, linestyle=0, thick=6
   oplot, z_Sheth01, S01_2d12, color=180, linestyle=0, thick=6
   oplot, z_Sheth01, S01_4d12, color=180, linestyle=0, thick=6
end
...
if (choice_Sheth01_fit eq 'y') then begin
   loadct, 6
   legend, [''], pos=[0.12,4.0], box=0, linestyle=0, thick=8, color=184
   xyouts, 0.50, 3.75, '!3Sheth01',charthick=4.2, charsize=2.0, color=184
