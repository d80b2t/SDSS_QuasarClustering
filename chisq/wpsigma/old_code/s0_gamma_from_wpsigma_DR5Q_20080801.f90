...
real*8, allocatable:: lg_s(:), s(:), xis(:), delta_xis(:), jack_err(:),wp(:), wpsigma_LS(:)
...
allocate(bin_DD_sigma(m), bin_DR_sigma(m), jack_err_div_sigma(m))
...
write(*,*)
choice = 3
if (choice .eq. 1) write(*,*) 'choice eq ', choice, ' xi(s)....'
!if (choice .eq. 2) write(*,*) 'choice eq ', choice, ' xi(r)....'
if (choice .eq. 3) write(*,*) 'choice eq ', choice, ' xi(s)....'
...
read(*,*) s_lo
write(*,*) "s high? (1.0, 5.0, 25.0, 70.0, 100.0)"
read(*,*) s_hi

write(*,*) "s_low set at  ",  s_lo, " h^-1 Mpc" 
write(*,*) "s_hi  set at  ",  s_hi, " h^-1 Mpc"
...
if(choice.eq.1) then      !xi(s) 
   ...
   if (choice_two .eq. 0) then
      open(10,file='../OP/OP_20080508/k_output_UNI22.dat')
      write(*,*) 'OP/20080508/k_output_UNI22.dat'
   elseif(choice_two .eq.1) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt30z0pnt68_10log.dat')
      !open(10,file='../OP/OP_20080121/k_output_20080121_0pnt30z0pnt68.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt30z0pnt68_10log.dat'
   elseif(choice_two .eq.2) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt68z0pnt92_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt68z0pnt92_10log.dat'
   elseif(choice_two .eq.3) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt92z1pnt13_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt92z1pnt13_10log.dat'
   elseif(choice_two .eq.4) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt13z1pnt32_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt13z1pnt32_10log.dat'
   elseif(choice_two .eq.5) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt32z1pnt50_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt32z1pnt50_10log.dat'
   elseif(choice_two .eq.6) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt50z1pnt66_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt50z1pnt66_10log.dat'
   elseif(choice_two .eq.7) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt66z1pnt83_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt66z1pnt83_10log.dat'
   elseif(choice_two .eq.8) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt83z2pnt02_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_1pnt83z2pnt02_10log.dat'
   elseif(choice_two .eq.9) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt02z2pnt20_10log.dat')
      !open(10,file='../OP/OP_20080215e/k_output_20080215_2pnt02z2pnt25.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt02z2pnt20_10log.dat'
   elseif(choice_two .eq. 10) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt20z2pnt90_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt20z2pnt90_10log.dat'
   elseif(choice_two .eq. 11) then
      open(10,file='../OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt00z0pnt30_10log.dat')
      write(*,*) 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt00z0pnt30_10log.dat'
   elseif(choice_two .eq. 12) then
      open(10,file='../OP/OP_20080307/k_output_20080307_0pnt70z1pnt40.dat')
      write(*,*) 'OP/OP_20080307/k_output_20080307_0pnt70z1pnt40.dat (DEEP2) '

   elseif(choice_two .eq. 13) then
      open(10,file='../2pt/k_output_UNI22_RASS_Xray_temp.dat')
      write(*,*) '../2pt/k_output_UNI22_RASS_Xray_temp.dat (Xrays!!) '
   endif
...
if(choice .eq. 3) then 
   ...
   if (choice_two .eq. 0) then
      ...
      open(12, file='../../jackknife/K_wp_output_UNI22_jackknife_errors.dat')

   elseif(choice_two .eq.1) then
      open(10,file='OP/OP_20080121/K_wp_output_20080121_0pnt30z0pnt68.dat')
      write(*,*) 'OP/OP_20080121/K_wp_output_20080121_0pnt30z0pnt68.dat'
   elseif(choice_two .eq.2) then
      open(10,file='OP/OP_20080122b/K_wp_output_20080122_0pnt68z0pnt92.dat')
      write(*,*) 'OP/OP_20080122b/K_wp_output_20080122_0pnt68z0pnt92.dat'
   elseif(choice_two .eq.3) then
      open(10,file='OP/OP_20080123/K_wp_output_20080123_0pnt92z1pnt13.dat')
      write(*,*) 'OP/OP_20080123/K_wp_output_20080123_0pnt92z1pnt13.dat'
   elseif(choice_two .eq.4) then
      open(10,file='OP/OP_20080124/K_wp_output_20080124_1pnt13z1pnt32.dat')
      write(*,*) 'OP/OP_20080124/K_wp_output_20080124_1pnt13z1pnt32.dat'
   elseif(choice_two .eq.5) then
      open(10,file='OP/OP_20080215/K_wp_output_20080215_1pnt32z1pnt50.dat')
      write(*,*) 'OP/OP_20080215/K_wp_output_20080121_1pnt32z1pnt50.dat'
   elseif(choice_two .eq.6) then
      open(10,file='OP/OP_20080215b/K_wp_output_20080215_1pnt50z1pnt66.dat')
      write(*,*) 'OP/OP_20080215b/K_wp_output_20080215_1pnt50z1pnt66.dat'
   elseif(choice_two .eq.7) then
      open(10,file='OP/OP_20080215c/K_wp_output_20080215_1pnt66z1pnt83.dat')
      write(*,*) 'OP/OP_20080215c/K_wp_output_20080215_1pnt66z1pnt83.dat'
   elseif(choice_two .eq.8) then
      open(10,file='OP/OP_20080215d/K_wp_output_20080215_1pnt83z2pnt02.dat')
      write(*,*) 'OP/OP_20080215d/K_wp_output_20080215d_1pnt83z2pnt02.dat'
   elseif(choice_two .eq.9) then
      open(10,file='OP/OP_20080215e/K_wp_output_20080215_2pnt02z2pnt25.dat')
      write(*,*) 'OP/OP_20080215e/K_wp_output_20080215_2pnt02z2pnt25.dat'
   elseif(choice_two .eq. 10) then
      open(10,file='OP/OP_20080122/K_wp_output_20080122_2pnt25z2pnt90.dat')
      write(*,*) 'OP/OP_20080122/K_wp_output_20080122_2pnt25z2pnt90.dat'
   elseif(choice_two .eq. 11) then
      open(10,file='OP/OP_20080307/K_wp_output_20080307_0pnt70z1pnt40.dat')
      write(*,*) 'OP/OP_20080307/K_wp_output_20080307_0pnt70z1pnt40.dat'
   endif
...
do while(istat .eq. 0)
   ...
   if(choice .eq. 1) then ! xi(s)
      read(10,*, IOSTAT=istat) lg_s(i), s(i), xis(i), delta_xis(i), &
           ...
           & xis_LS(i), xi_HAM(i)
      write(12,*) i, lg_s(i), s(i), xis(i), delta_xis(i), &
           & bin_DD(i), bin_DR(i), bin_RR(i), &
           & xis_LS(i), xi_HAM(i)
   ...
   elseif(choice .eq. 3) then 
      read(10,*,IOSTAT=istat) sigma(i), log_sigma(i), xis(i),  delta_xis(i), &
           &  bin_DD_sigma(i), bin_DR_sigma(i), xi_HAM(i), wpsigma_LS(i)
      
      read(12,*,IOSTAT=istat)  i_bin(i), j_bin(i), COV_ii(i), jack_err(i)
      
      s(i)                  = sigma(i)
      xis_LS(i)             =  wpsigma_LS(i)
      jack_err_div_sigma(i) = jack_err(i) / sigma(i)
      !write(*,*) i, sigma(i),  wpsigma_LS(i), jack_err(i)
      write(*,*) i, s(i),  xis_LS(i), jack_err(i)
...
do j=1,300
   ...
   if(choice.eq. 1 .and. s_hi .lt. 5.0) then
      ...
      s_0vec(j) = 20.+float(j-1)*5.0 
      !s_0vec(j) = 200.+float(j-1)*5.0 
      !           200.+float(j-1)*2.0
...
do j=1,300
   ...
   do k=1,300
      ...
      if (j .eq. 1 .and. gamma .ge. 1.80 .and.  gamma .le. 1.90) then
         !write(*,*) 'gamma, A' 
         write(*,*) gamma, A
      end if
      ...
      do i=1,n_input
         if (  jack_err(i).gt.0.0  .and.  s(i).ge.s_lo  .and.  s(i).le.s_hi) then
            ...
            xi_s_test(i) = (s(i)/s0)**(-1.* gamma)  * A !Not w(theta)

            chi2(j,k) = chi2(j,k) + (((  xi_s_test(i)- (xis_LS(i)/s(i)))**2.) /  &
                 & (jack_err_div_sigma(i)*jack_err_div_sigma(i)) )
            chi2_COV(j,k) = chi2_COV(j,k) + ( &
                 & ((xi_s_test(i)-xis_LS(i))*(xi_s_test(i+1)-xis_LS(i+1)))* &
                 & (COV_I(i,i+1)))
      ...
      if (chi2(j,k) .ge. 0.0000000) then
      write(21,20) chi2(j,k), (chi2(j,k)/(count-params)), &
           &       s_0vec(j), gammavec(k), j,k
      !write(*,*) chi2(j,k), r_0vec(j), gammavec(k)
      end if
...
if(choice .eq. 3 .or. choice .eq. 4) then 
   ...
   write(*,*)' i, s(i), xis_LS(i), wp_sigma_measured(i), IC ' 
   
   do i=1,n_input
      if(xis_LS(i) .gt. 0) then
         if(s(i) .ge. s_lo  .and.   s(i) .le. s_hi ) then
            
            wp_sigma(i) = capital_C * (r_nought_fixed**gamma_fixed) * &
                 & (s(i)**(1- gamma_fixed))  
            !
            !where s(i) in this case is sigma (equivalent to r_p)
            !
            !
            write(*,*) i, s(i), xis_LS(i), wp_sigma(i), xis_LS(i), &
                 & (wp_sigma(i) - xis_LS(i))         
         end if
      end if
