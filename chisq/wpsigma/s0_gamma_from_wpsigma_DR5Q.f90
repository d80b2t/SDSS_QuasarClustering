...
write(*,*)
choice = 3
if (choice .eq. 3) write(*,*) 'choice eq ', choice, ' w(rp)....'
...
write(*,*) "rp low ? (0.1, 0.40, 1.00)"
read(*,*) s_lo
write(*,*) "rp high? (1.0, 5.0, 25.0, 70.0, 100.0)"
read(*,*) s_hi
...
if(choice .eq. 3) then 
   ...
   if (choice_two .eq. 0) then
      ...
      !! pi_cut =63
      !open(10,file='../../OP/OP_20080508/K_wp_output_UNI22_picut18.dat') 
      !! pi_cut=25
      !open(10,file='../../OP/OP_20080508/K_wp_output_UNI22_picut21.dat')  
      !!pi_cut=100
