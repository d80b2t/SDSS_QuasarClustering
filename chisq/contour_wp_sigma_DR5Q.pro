...
readcol, 'k_output_2SLAQ_chisq_1.dat', chi2, bla, s0, gamm, bla2, bla2, format = 'd,d,d,d,i,i'
...
contour, chi2_ran, gamm, s0, levels=[1.0,4.00,9.00], $
...
; xrange=[1.5,2.0], xstyle=1,yrange=[6.,9.], $            ; for  xi(s), xi(r) 
 xrange=[0.0,2.5], xstyle=1,yrange=[0.,30.], $          ; for   2SLAQ xi(s), small scales
...
oplot, [gamma_j], [r0_j], psym = 5

result_r0 = stddev(r0_j)
result_gamma = stddev(gamma_j)


print, r0_j
print, gamma_j
print, 'std dev on r0=', result_r0, ' and on gamma=', result_gamma

result_r0 = result_r0 * sqrt(32)
result_gamma = result_gamma *  sqrt(32)

print, 'std dev on r0=', result_r0, ' and on gamma=', result_gamma

;oplot, [gammamin_ran_o+result_gamma], [somin_ran_o], psym = 7
;oplot, [gammamin_ran_o-result_gamma], [somin_ran_o], psym = 7
;oplot, [gammamin_ran_o], [somin_ran_o+result_r0], psym = 7
;oplot, [gammamin_ran_o], [somin_ran_o-result_r0], psym = 7
