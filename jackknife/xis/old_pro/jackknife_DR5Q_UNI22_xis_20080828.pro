...
for i=0L, n_elements(RR)-1 do printf, 16, COV[xx,i], format='(39(d12.8,1x))'
close, 16
   ...
   for jj = 0L, 300-1 do begin
      ...
      for i=0L, N-1 do begin
         for j=0L, N-1 do begin
            ...
            ;printf, 15, s_nought, gamma, i, j, $
            ;        s[i], xis_LS[i], model_xis_i, $
            ;        s[j], xis_LS[j], model_xis_j, inv_COV(i,j),  $
            ;        ((xis_LS[i] - model_xis_i) * inv_COV(i,j) * (xis_LS[j] - model_xis_j)), $
            ;        chi_sq, $
            ;        format='(f12.6,1x, f12.6,1x, i4,i4,2x, d12.8,1x,d12.8,1x,d12.8,1x, d12.8,1x,d12.8,1x,d12.8,1x, d18.4,1x, d18.4,1x, d18.4)'
...
;         AX=300, $
;         AZ=330, $
         SKIRT=0.0, TITLE = 'Covariance Matrix, !3n(s)!N', CHARSIZE = 2, $
