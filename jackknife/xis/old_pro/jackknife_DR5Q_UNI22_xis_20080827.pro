...
xx = indgen(39) 
for i=0L, 39-1 do printf, 16, COV[xx,i], format='(39(d12.8,1x))'
close, 16
...
for i=0L, N-1 do begin
   for j=0L, N-1 do begin
      ...
      ;for k=0L, n_elements(s[w]) do begin
      
      printf, 15, i, j, $
              s[i], xis_LS[i], model_xis_i, $
              s[j], xis_LS[j], model_xis_j, inv_COV(i,j), chi_sq, $
              format='(i4,i4,2x, d12.8,1x,d12.8,1x,d12.8,1x, d12.8,1x,d12.8,1x,d12.8,1x,     d18.4,1x, d18.4)'
