...
indx_midz_cut = where(data_full.z ge 2.0 and data_full.z le 3.0, N_midz_cut)
help, indx_midz_cut
print, 'N_midz_cut from DR5Q (2.0<z<3.0)', N_midz_cut
print
set_plot, 'ps'
device, filename='SDSS_Quasar_Nof2z3.ps', $
...
legend,['DR5Q','2<z<3'],line=[1,0], box=0, position=[2.0,2250], color=[0,64],charsize=1.8, charthick=4.2
