...
print
readcol, 'Ross08.dat', lo_z, z_bar, hi_z, s0, s0_plus, s0_minus
...
oplot, t_lookback, s0, psym=1, color=0, thick=4;, symsize=4
...
plot, redshift, r0, xrange=[0,6], yrange=[0.,25], $ 
      psym=4, $
