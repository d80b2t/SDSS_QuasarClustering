;;+
;;
;; The ``3x4'' plot to show the xi(s) for each redshift subsample
;;
;;-
...
readcol, "OP/UNI22_evol_10logbins_xis/k_output_UNI22_0pnt00z0pnt30_10log.dat", $
         log_s, s_0pnt00, xis_std, delta_xis, DD_0pnt00, DR, RR, $
         xis_LS_0pnt00, xis_HAM, ratio
...
readcol, "OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt20z2pnt90_10log.dat", $
         s_log, s_2pnt20, xis_std, delta_xis, DD_2pnt20, DR, RR, $
         xis_LS_2pnt20, xis_HAM, ratio
print, 'OP/UNI22_evol_10logbins_xis/k_output_UNI22_2pnt20z2pnt90_10log.dat read-in '
print
...
set_plot, 'ps'
device, filename='xis_DR5_quasars_3by4_for_evol_temp.eps', $
        xsize=8.5, ysize=8.5, $  ;; for .pdf
...
plot, s, xis_q_full, $
      ...
      /xlog, /ylog, $
      xrange=[xmin, xmax], $
      yrange=[ymin, ymax] , $    ; bring down to 500 w/o V. PREL.
      xstyle=1, ystyle=1, $
      thick=2.2, $
      ...
      ytickformat='(f6.2)', $
      color=0
poisson_0pnt00 = (1.+xis_LS_0pnt00) * (sqrt(2./DD_0pnt00))
oplot,   s_0pnt00,  xis_LS_0pnt00, psym=8,                      color=0 ;240
errplot, s_0pnt00, (xis_LS_0pnt00-poisson_0pnt00), (xis_LS_0pnt00+poisson_0pnt00), $
         thick=2.0,                                             color=0 ;240
xyouts, label_a, label_b, '<z>=0.24', charsize=1.2, charthick=4.2,      color=0 ;240
xyouts, label_x, label_y,  '  N!IQ!N=1051', charsize=1.2, charthick=4.2, color=0 ;240
...
errplot, s_0pnt30, (xis_LS_0pnt30-poisson_0pnt30), (xis_LS_0pnt30+poisson_0pnt30), $
         thick=2.0,                                             color=0 ;240
xyouts, label_a, label_b, '<z>=0.49', charsize=1.2, charthick=4.2,      color=0 ;240
xyouts, label_x, label_y,  '  N!IQ!N=5404', charsize=1.2, charthick=4.2, color=0 ;240
...
xyouts, label_a, label_b, '<z>=0.80', charsize=1.2, charthick=4.2,       color=0 ;216
xyouts, label_x, label_y,  '  N!IQ!N=3001', charsize=1.2, charthick=4.2,  color=0 ;240
...
xyouts, label_a, label_b, '<z>=1.03', charsize=1.2, charthick=4.2,      color=0; 192
xyouts, label_x, label_y,  '  N!IQ!N=3365', charsize=1.2, charthick=4.2, color=0 ;192
...
xyouts, label_a, label_b, '<z>=1.23', charsize=1.2, charthick=4.2,      color=0 ;168
xyouts, label_x, label_y,  '  N!IQ!N=3623', charsize=1.2, charthick=4.2, color=0 ;168
...
xyouts, label_a, label_b, '<z>=1.41', charsize=1.2, charthick=4.2,      color=0 ;144
xyouts, label_x, label_y,  '  N!IQ!N=3332', charsize=1.2, charthick=4.2, color=0 ;168
...
xyouts, label_a, label_b, '<z>=1.58', charsize=1.2, charthick=4.2,      color=0 ;120
xyouts, label_x, label_y,  '  N!IQ!N=3405', charsize=1.2, charthick=4.2, color=0 ;120
...
xyouts, label_a, label_b, '<z>=1.74', charsize=1.2, charthick=4.2,      color=0 ;96
xyouts, label_x, label_y,  '  N!IQ!N=3240', charsize=1.2, charthick=4.2, color=0 ;96
...
xyouts, label_a, label_b, '<z>=1.92', charsize=1.2, charthick=4.2,      color=0 ;72
xyouts, label_x, label_y,  '  N!IQ!N=2970', charsize=1.2, charthick=4.2, color=0 ;72
...
xyouts, label_a, label_b, '<z>=2.10', charsize=1.2, charthick=4.2,      color=0 ;48
xyouts, label_x, label_y,  '  N!IQ!N=1899', charsize=1.2, charthick=4.2, color=0 ;48
...
plot, s, xis_q_full, $
      ...
      ytickformat='(a1)', $
      color=0
poisson_2pnt20 = (1.+xis_LS_2pnt20) * (sqrt(2./DD_2pnt20))
oplot,   s_2pnt20,  xis_LS_2pnt20, psym=8,                      color=0 
errplot, s_2pnt20, (xis_LS_2pnt20-poisson_2pnt20), (xis_LS_2pnt20+poisson_2pnt20), $
            thick=2.0,                                          color=0 
xyouts, label_a, label_b, '<z>=2.46', charsize=1.2, charthick=4.2,      color=0 
xyouts, label_x, label_y,  '  N!IQ!N=2409', charsize=1.2, charthick=4.2, color=0 
