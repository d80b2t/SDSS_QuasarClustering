...
print
readcol, 'Ross08_xir_UNIFORM_evol_gamma2pnt0_sigmamin1_v2.dat', $
...
xyouts, 0.2, 28, '!!!! V. PRELIMINARY RESULT !!!!!8', $
           charsize=2.2, charthick=6.2, color=0
...
loadct, 6
set_plot, 'ps'
device, filename='r0_with_redshift_z3.eps', $
...
plot, z_bar, r0, $
      ...
      psym=3, $
      xstyle=8+1, ystyle=3, $
      thick=4.2*talk, xthick=4.2*talk, ythick=4.2*talk, $
      charsize=2.2*(talk), charthick=4.2*talk, $
;      title='!6r!I0!N Evolution', $
      xtitle='!8z, redshift', $
      ytitle='!8r!I0!n / !8h!E-1!n!8 Mpc', $
      color=0
...
plotsym,0,2
oplot, z_bar, r0, psym=8, color=0, thick=1;, symsize=4
oploterror, z_bar, r0, z_err_lo, r0_minus, $
            /lobar, errthick=1, errcolor=0, psym=1, color=0
oploterror, z_bar, r0, z_err_hi, r0_plus, $
            /hibar, errthick=1, errcolor=0, psym=1, color=0
w = where(z_bar lt 2.9)
plotsym,0,2,/fill
oplot, z_bar[w], r0[w], psym=8, color=0, thick=4;, symsize=4
...
;   plot,x,y,psym=plotsym(/circle,scale=2,/fill)
   ...
   choice_DR5Q_RASS_points = 'n'
;  read, choice_DR5Q_RASS_points, PROMPT=' - Plot DR5Q-RASS Quasar points?? y/n '
   if choice_DR5Q_RASS_points eq 'y' then begin
      ; loadct, 1 and color=200
      loadct, 6 ;; for .ppt talk
      oplot, z_bar_RASS, r0_RASS, psym=4, color=200, thick=20, symsize=1.5
      oploterror, z_bar_RASS, r0_RASS, lo_z_RASS, r0_minus_RASS, $
                  /lobar, errthick=4, errcolor=200, psym=1, color=200
      oploterror, z_bar_RASS, r0_RASS, hi_z_RASS, r0_plus_RASS, $
                  /hibar, errthick=4, errcolor=200, psym=1, color=200
      legend, ['!3SDSS DR5Q-RASS!8'], psym=4, color=200, pos=[1.3,24.5], $
              box=0, charthick=4.2, charsize=1.8, thick=20     
      loadct, 6
   endif
endif
...
axis, xaxis=1, xtickv=zz, xtickn=tlab, $
      xticks=nticks-1, $
      xthick=4.2*talk, charthick=4.2*talk, $
      xtitle='!8 Age of the Universe (Gyr)',charsize=2
...
if (choice_Quasar_points eq 'y') then begin
   plotsym,0,1.0,/fill, thick=4
   legend, ['!3SDSS DR5Q (uni)'], psym=8, color=0, pos=[0.1,23], box=0, $
           charthick=4.2, charsize=1.8, thick=4.2
   plotsym,8,1.0, thick=4, /fill
   legend, ['SDSS photo-z'], psym=8, color=64, pos=[0.1,21.5], box=0, $     
           charthick=4.2, charsize=1.8, thick=4.2
   loadct, 13
   legend, ['SDSS-DEEP2'], psym=4, color=24, pos=[0.1,20.], box=0, $
           charthick=4.2, charsize=1.8, thick=5.2
   legend, ['AGN-LBGs'], psym =4, color=80, pos=[0.1,18.5], box=0, $
           charthick=4.2, charsize=1.8, thick=1.2
   tri_one = [0.165, 0.200, 0.235, 0.200]
   tri_two = [17.30,   17.80,  17.30,  16.80]
...
if (choice_AGN_points eq 'y') then begin
   plotsym,3,1.0,/fill, thick=4
   legend, ['!3CDF-N&S (Gilli05)'], psym=8, color=128, pos=[1.3,23], box=0, $
           charthick=4.2, charsize=1.8
   loadct, 0
   xyouts, 0.82, 10.0, 'S', color=255, size=1, charthick=4
   xyouts, 0.94,  5.25, 'N', color=255, size=1, charthick=4
   
   loadct, 6
   plotsym,4,1.0, thick=4
   legend, ['!3XMM-COSMOS (Gilli08)'], psym=8, color=128, pos=[1.3,21.5], box=0, $  
           charthick=4.2, charsize=1.8
   plotsym,4,1.0, /fill, thick=4
   legend, ['!3XMM-COSMOS (Miyaji07)'], psym=8, color=128, pos=[1.3,20], box=0, $
           charthick=4.2, charsize=1.8
   loadct, 0
   xyouts, 0.58,  12.3, 'U', color=255, size=1, charthick=4
   xyouts, 0.845,  6.45,  'M', color=255, size=1, charthick=4
   xyouts, 1.055,  11.45, 'S', color=255, size=1, charthick=4
   ...
   Y = SIN(A) ;/1.75
   USERSYM, Y, X, /fill
   legend, ['XMM-2dF (Basilakos04)'], psym=8, color=24, pos=[1.3,18.5], box=0, $
           charthick=4.2, charsize=1.8
endif
