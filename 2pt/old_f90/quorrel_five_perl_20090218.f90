...
! O/P FILES
open( 9,file='k_output_UNI22_0pnt30z0pnt68_noDD_v2.dat')
open(10,file='k_output_lin_UNI22_0pnt30z0pnt68_noDD_v2.dat')
open(18,file='k2d_output_UNI22_0pnt30z0pnt68_noDD_v2.dat')
open(27,file='K_wp_output_UNI22_0pnt30z0pnt68_noDD_v2.dat')
!
open(44,file='z_values_UNI22_0pnt30z0pnt68_noDD_v2.dat')
open(55,file='ra_dec_z_DR5Q_used_UNI22_0pnt30z0pnt68_noDD_v2.dat')
open(56,file='ra_dec_z_randoms_used_UNI22_0pnt30z0pnt68_noDD_v2.dat')
!
...
!           & (bin_DD_2d(k_sigma,k_pi_para) .ne. 0)) then
      ...
      if(bin_DR_2d(k_sigma,k_pi_para) .ne. 0) then
         ...
         if(bin_DD_2d(k_sigma,k_pi_para) .ne. 0) then
            delta_xi_sigma_pi(k_sigma,k_pi_para) = (1.0 + &
