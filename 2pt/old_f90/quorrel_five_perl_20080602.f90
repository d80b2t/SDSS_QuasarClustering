...
! O/P FILES
open( 9,file='k_output_UNI22_jack_N2.dat')
open(10,file='k_output_lin_UNI22_jack_N2.dat')
open(18,file='k2d_output_UNI22_jack_N2.dat')
open(27,file='K_wp_output_UNI22_jack_N2.dat')
!
open(44,file='z_values_UNI22_jack_N2.dat')
open(55,file='ra_dec_z_DR5Q_used_UNI22_jack_N2.dat')
open(56,file='ra_dec_z_randoms_used_UNI22_jack_N2.dat')
!
...
do while (istat .eq. 0) 
   ...
   if((ra_DR5Q(i) .le. ra_min) .or. (ra_DR5Q(i) .ge. ra_max)) then
      if((dec_DR5Q(i) .le. dec_min) .or. (dec_DR5Q(i) .ge. dec_max)) then
...
do while (istat .eq. 0) 
   ...
   if((ra_rnd_npr (i) .le. ra_min) .or. (ra_rnd_npr(i) .ge. ra_max)) then
      if((dec_rnd_npr(i) .le. dec_min) .or. (dec_rnd_npr(i) .ge. dec_max)) then
