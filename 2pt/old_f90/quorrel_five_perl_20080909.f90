...
!!  UNIFORMS   UNIFORMS   UNIFORMS   UNIFORMS   UNIFORMS   UNIFORMS 
open(1,file='../data/DR5QSO_uni_data.dat')
!open(1,file='../data/DR5QSO_uni_data_wFibre.dat')
...
! O/P FILES
open( 9,file='k_output_UNI22_UNI29_temp.dat')
open(10,file='k_output_lin_UNI22_UNI29_temp.dat')
open(18,file='k2d_output_UNI22_UNI29_temp.dat')
open(27,file='K_wp_output_UNI22_UNI29_temp.dat')
!
open(44,file='z_values_UNI22_UNI29_temp.dat')
open(55,file='ra_dec_z_DR5Q_used_UNI22_UNI29_temp.dat')
open(56,file='ra_dec_z_randoms_used_UNI22_UNI29_temp.dat')
!
