...
open(1,file='../data/DR5QSO_pri_data.dat')
open(2,file='../randoms/randoms_npr_PRIMARY.dat')
...
write(*,*) 'Read-in data  points', i, ' of which', &
      ...
      & '% of the FULL HOMOGENEOUS sample'
...
write(*,*) 'N_rnd', N_rnd, 'N_rnd_total', N_rnd_total
...
do i=1, N_LRG_sample-1
   ...
   do j=i+1,N_LRG_sample
      ...
      !write(*,*) 'ra_theta(i,j)',  ra_theta(i),   ra_theta(j)
      !write(*,*) 'dec_theta(i,j)', dec_theta(i), dec_theta(j)
...
1500 format (f5.2,1x,   f15.6,1x, &
          &  f15.8,1x, f15.13,1x,   &
          &  f12.0,1x,    f12.0,1x, f12.0,1x, &
          &  f15.10,1x, f15.10,1x, f14.5)
