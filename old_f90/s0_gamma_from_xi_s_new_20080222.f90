...
if(choice.eq.1) then      !xi(s) 
   ...
   if (choice_two .eq. 0) then
      open(10,file='OP/OP_20080120/k_output_20080120_0pnt30z2pnt90.dat',status='old')
      write(*,*) 'OP/OP_20080120/k_output_20080120_0pnt30z2pnt90.dat'
   elseif(choice_two .eq.1) then
      open(10,file='OP/OP_20080121/k_output_20080121_0pnt30z0pnt68.dat',status='old')
      write(*,*) 'OP/OP_20080121/k_output_20080121_0pnt30z0pnt68.dat'
   elseif(choice_two .eq. 10) then
      open(10,file='OP/OP_20080122/k_output_20080122_2pnt25z2pnt90.dat',status='old')
...
!end if !choice .eq. 2
write(*,*)
write(*,*) '1, chi_sq_min, j_min,   k_min'
