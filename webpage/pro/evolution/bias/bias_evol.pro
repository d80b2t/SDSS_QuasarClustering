...
print  
print, ' IDL> red, omega0=0.237, omegalambda=0.763, h100=0.73   '
print
print, '------------------------------------------------------'
print, '------------------------------------------------------'
print
...
readcol, 'Myers07_bias_Table1.dat', $
         ...
         bias_Myers07_a, err_bias_Myers07_plus_a, err_bias_Myers07_minus_a, $
         skip1, skip2, skip3, skip4, skip5, skip6, $
         bias_Myers07_b, err_bias_Myers07_plus_b, err_bias_Myers07_minus_b, $
...
print
readcol, 'Ross08_bias_from_xir_evol.dat', $
         lo_z_xir, z_bar_xir, hi_z_xir, $
         bias_UNI22_xir, bias_plus_xir, bias_minus_xir 
t_lookback_xir    = getage(z_bar_xir)
t_lookback_lo_xir = abs(getage(z_bar_xir) -  getage(hi_z_xir))
t_lookback_hi_xir = abs(getage(z_bar_xir) -  getage(lo_z_xir))
print, 'READ-IN Ross08_bias_from_xir_evol.dat'
print
print
...
z_err_lo_xir = abs(z_bar_xir - lo_z_xir) 
z_err_hi_xir = abs(z_bar_xir - hi_z_xir) 
...
loadct, 6
set_plot, 'ps'
device, filename='bias_with_redshift_z6.eps', $
        xsize=8.5, ysize=7.0,  $
        xoffset=0.0, yoffset=0.2, $
        /encapsulated, $
        /inches, /color
plot, survey_z, r0, $
      position=[0.14,0.14,0.96,0.88], $
...
;;          color=0, linestyle=2, thick=6
   ...
   legend, ['  '], linestyle=0, color=0, pos=[0.10, 15.0], box=0, thick=12   
   legend, ['  '], linestyle=1, color=0, pos=[0.10, 13.0], box=0, thick=8
   legend, ['  '], linestyle=2, color=0, pos=[0.10, 11.0], box=0, thick=8
;   legend, ['  '], linestyle=3, color=0, pos=[0.10, 7.0], box=0,   thick=8
   legend, ['  '], linestyle=0, color=0, pos=[0.10,  9.0], box=0, thick=0
...
;   legend, ['!8i=19.0'], pos=[0.72, 8.2], box=0, charthick=4.2, charsize=1.4
   ...
   legend, ['!8Inefficient Feedback'],   pos=[0.72,15.2], box=0, charthick=4.2, charsize=1.4
   legend, ['!8Efficient Feedback'],   pos=[0.72,13.2], box=0, charthick=4.2, charsize=1.4
   legend, ['!8Maximal Growth'],   pos=[0.72,11.2], box=0, charthick=4.2, charsize=1.4
;   legend, ['!8L~L!E*!N'], pos=[0.72, 7.2], box=0, charthick=4.2, charsize=1.4
   legend, ['!8All models, i=20.2'],   pos=[0.72,9.2], box=0, charthick=4.2, charsize=1.4
;   legend, ['!8 i=20.2'],   pos=[0.82,8.2], box=0, charthick=4.2, charsize=1.4
...
;; points from Ross et al. using \bar{xi(r)}...
plotsym,0,1.5
;oplot, z_bar_xir, bias_UNI22_xir, psym=8, color=0, thick=4 ;, symsize=4
;oploterror, z_bar_xir, bias_UNI22_xir, z_err_lo_xir, bias_minus_xir, $
;            /lobar, errthick=4, errcolor=0, psym=1, color=0
;oploterror, z_bar_xir, bias_UNI22_xir, z_err_hi_xir, bias_plus_xir, $
;            /hibar, errthick=4, errcolor=0, psym=1, color=0
...
choice_Jing98_fit = 'n'
read, choice_Jing98_fit, PROMPT=' - Plot Jing et al. (1998) bias model fit? y/n  '

choice_Sheth01_fit = 'y'
read, choice_Sheth01_fit, PROMPT=' - Plot Sheth et al. (2001) bias model fit? y/n  
...
loadct, 6
set_plot, 'ps'
device, filename='bias_with_redshift_z3.eps', $
        xsize=8.5, ysize=7.0,  $
        xoffset=0., yoffset=0.2, $
        /encapsulated, $
        /inches, /color
plot, survey_z, r0, $
      position=[0.14,0.16,0.96,0.88], $
...
if (choice_Jing98_fit eq 'y') then begin
   ...
   print
   oplot, z_Jing98, J98_5d11, color=32, linestyle=2, thick=6
   oplot, z_Jing98, J98_1d12, color=32, linestyle=2, thick=6
   oplot, z_Jing98, J98_2d12, color=32, linestyle=2, thick=6
;   oplot, z_Jing98, J98_3d12, color=32, linestyle=2, thick=6
;   oplot, z_Jing98, J98_4d12, color=32, linestyle=2, thick=6
...
if (choice_Jing98_fit eq 'y') then begin
   ...
   legend, [''], pos=[0.12,3.6], box=0, linestyle=2, thick=8, color=32
   xyouts, 0.50, 3.35, '!3Jing98',charthick=4.2, charsize=2.0, color=0

;   xyouts, 2.50, 5.5, '!812.5!N', $
