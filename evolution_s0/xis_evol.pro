...
loadct, 6
set_plot, 'ps'
device, filename='s0_with_lookback_time.eps', $
...
loadct, 6
set_plot, 'ps'
device, filename='s0_with_redshift_z3.eps', $
        xsize=8.5, ysize=6.0,  /inches, /color, $
        /encapsulated, $
        xoffset=0, yoffset=0.2
plot, z_bar, s0, $
;;      position=[0.14,0.14,0.96,0.98], $   ;; for .pdfs 
      position=[0.14,0.16,0.96,0.88], $   ;; for .eps 
