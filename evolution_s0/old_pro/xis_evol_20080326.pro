...
;loadct, 13
set_plot, 'ps'
;device, filename='s0_with_lookback_time.ps', xsize=12, ysize=8, /inches, /color
device, filename='s0_with_lookback_time.ps', xsize=8, ysize=6,  /inches, /color
...
device, filename='s0_with_redshift.ps', xsize=8, ysize=6,  /inches, /color
plot, survey_z, r0, xrange=[0,5], yrange=[0.,30], $ 
      psym=4, $
...
oplot, z_bar_Myers07, s0_Myers07, psym=1, color=64, thick=4;, symsize=4
oploterror, z_bar_Myers07, s0_Myers07, z_err_lo_Myers07, err_s0_Myers07, $
            /lobar, errthick=4, errcolor=64, psym=1, color=64
oploterror, z_bar_Myers07, s0_Myers07, z_err_hi_Myers07, err_s0_Myers07, $
